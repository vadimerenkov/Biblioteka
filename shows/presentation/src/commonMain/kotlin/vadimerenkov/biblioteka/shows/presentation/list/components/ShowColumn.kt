...
private fun ShowColumnItem(
	...
	Row(
		...
		Column {
			...
			val dates = when {
				show.firstAirDate != null && show.lastAirDate == null -> show.firstAirDate.toString()
				show.firstAirDate != null && show.lastAirDate != null -> "${show.firstAirDate} - ${show.lastAirDate}"
				else -> null
			}
			dates?.let {
				Text(
